...
int main(int argc, char **argv)
{
  ...
  rclcpp::Client<ros2_part_interfaces::srv::AddThreeInts>::SharedPtr client =
    node->create_client<ros2_part_interfaces::srv::AddThreeInts>("add_three_ints");

  auto request = std::make_shared<ros2_part_interfaces::srv::AddThreeInts::Request>();
